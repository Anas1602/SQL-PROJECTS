...
-- Find all triplets (startpt - middlept - endpt) representing the mountain huts that may be used for construction of a ski slope
...
with cte_trails1 as (
		...
		cte_trails2 as (
				select 
					...
					-- Check Altitude between 2 huts
					case
						When start_hut_altitude > h2.altitude then 1 else 0
					end altitude_flag
				from cte_trails1 t2
